...
SELECT Ename, Hire_date, DATE_FORMAT(DATE_ADD(Hire_date, INTERVAL 6 MONTH) + INTERVAL (7 - WEEKDAY(DATE_ADD(Hire_date, INTERVAL 6 MONTH))) DAY, '%Y-%m-%d-%W') AS Salary_Review_Date
FROM EMPLOYEE;
